...
$alemail=$email->paginator($pageStartFrom,$iteamPerPage);
...
<div class="container">
    <h1>Email List</h1>
    <a href="create.php" class="btn btn-info" role="button">Add new email</a>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a href="veiw.php?id=<?php echo $email['id']?>" class="btn btn-info" role="button">View</a>
                    ...
                    <a href="trash.php?id=<?php echo $email['id']?>" class="btn btn-success" role="button">Trash</a>
                </td>
            </tr>
