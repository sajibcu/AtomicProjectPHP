...
<form class="form-horizontal" role="form" method="post" action="update.php">
    <div class="form-group">
        <div class="col-sm-10">
            <input value="<?php echo $singleItem['id']?>" name="id" hidden>
            <label>Name :</label>
            <input type="text"  style="width: auto" st class="form-control" required  value="<?php echo $singleItem['name']?>" name="name">
        </div>
        <div class="col-sm-10">
            <label>Birthday :</label>
            <input type="date"  style="width: auto" required class="form-control" size="" value="<?php echo $singleItem['birthday']?>" name="birthday">
        </div>
        <div class="form-group">
