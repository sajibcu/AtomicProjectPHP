...
$alorg=$org->paginator($pageStartFrom,$iteamPerPage);
...
<div class="container">
    ...
    <a href="create.php" class="btn btn-info" role="button">Add new Organization</a>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                ...
                <td>
            <a href="veiw.php?id=<?php echo $org['id']?>" class="btn btn-info" role="button">View</a>
            <a href="edit.php?id=<?php echo $org['id']?>" class="btn btn-primary" role="button">Edit</a>
            <a  href="delete.php?id=<?php echo $org['id']?>" class="btn btn-danger" role="button">Delete</a>
            <a href="trash.php?id=<?php echo $org['id']?>" class="btn btn-success" role="button">Trash</a>
                </td>
            </tr>
